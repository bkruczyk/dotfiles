...
static const char *voldown[]   = { "/usr/bin/pamixer", "-d", "5", NULL };
...
static key keys[] = {
    ...
    {  MOD ,              XK_p,        focusnext,         {.i=TWOBWM_FOCUS_PREVIOUS}},
    // Kill a window
    {  MOD ,              XK_q,          deletewin,         {}},
    // Resize a window
    ...
    {  MOD |ALT ,         XK_x,          maximize,          {.i=TWOBWM_FULLSCREEN_OVERRIDE_OFFSETS}},
    // Maximize vertically
    ...
    {  MOD |ALT ,         XK_v,          sendtonextworkspace,{}},
    {  MOD |ALT ,         XK_c,          sendtoprevworkspace,{}},
    // Iconify the window
    {  MOD ,              XK_i,          hide,              {}},
    ...
    {  MOD ,              XK_f,          fix,               {}},
    // Move the cursor
    {  MOD ,              XK_equal,        cursor_move,       {.i=TWOBWM_CURSOR_UP_SLOW}},
    {  MOD ,              XK_minus,        cursor_move,       {.i=TWOBWM_CURSOR_DOWN_SLOW}},
    {  MOD ,              XK_bracketright, cursor_move,       {.i=TWOBWM_CURSOR_RIGHT_SLOW}},
    {  MOD ,              XK_bracketleft,  cursor_move,       {.i=TWOBWM_CURSOR_LEFT_SLOW}},
    ...
    {  MOD |ALT,          XK_bracketleft,   start,             {.com = click1}},
    {  MOD |ALT,          XK_minus,         start,             {.com = click2}},
    {  MOD |ALT,          XK_bracketright,  start,             {.com = click3}},
